% This may not be needed.  I used this to process only the photos
% corresponded to "good" clustering.  (This was a temporary file)

%Modified so that only the "good" files are processed.
load GraphOK;
